                        ...
                        <ul class="cui-menu-left-list cui-menu-left-list-root">
                            ...
                            <li class="cui-menu-left-item cui-menu-left-submenu">
                                ...
                                <ul class="cui-menu-left-list">
                                    ...
                                    <?php if(auth()->check() && auth()->user()->hasRole('super|owner')): ?>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" required>
                                    ...
                                    <option value="<?php echo e($typeofuser->name); ?>"><?php echo e($typeofuser->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\HeroTemplate\resources\views/layouts/master.blade.php ENDPATH**/ ?>