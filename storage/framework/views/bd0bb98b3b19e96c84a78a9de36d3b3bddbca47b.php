                    ...
                    <div class="col-sm-12">
                        <form class="form-horizontal" action="<?php echo e(route('tasks.update',$task)); ?>" method="post">
                            <?php echo e(method_field('PUT')); ?>
                                    ...
                                    Task name:
                                    <br />
                                    <input class="form-control" type="text" name="name" value="<?php echo e($task->name); ?>" />
                                    <br /><br />
                                    Task description:
                                    <br />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\educationhero\resources\views/tasks/edit.blade.php ENDPATH**/ ?>