                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="ชื่อประเทศ(เต็ม)" name="name" value="<?php echo e($country->name); ?>" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="ชื่อประเทศ(ย่อ)" name="name_short" value="<?php echo e($country->name_short); ?>" required/>
                                        </div>
                                    </div>
