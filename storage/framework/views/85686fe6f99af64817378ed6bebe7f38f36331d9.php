...
$typeofuser = !empty($user->id) ? old('typeofuser', $user->getprofiles->zipcode2) : old('zipcode2', '');
$status = '';
?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" style="font-family: 'Pridi', serif;" required id="province1" name="province1">
                                    ...
                                    <option  value="<?php echo $value->name_th; ?>" <?php echo $user->getprofiles->province1 == $value->name_th ? 'selected' : ''; ?>><?php echo $value->name_th; ?></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" required id="province2" style="font-family: 'Pridi', serif;" name="province2">
                                    <option value="" disabled selected>--<?php echo app('translator')->getFromJson('logs.select'); ?>--</option>
                                    <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option  value="<?php echo $value->name_th; ?>" <?php echo $user->getprofiles->province2 == $value->name_th ? 'selected' : ''; ?>><?php echo $value->name_th; ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\HeroTemplate\resources\views/users/_form.blade.php ENDPATH**/ ?>