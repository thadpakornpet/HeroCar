...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <script src="<?php echo e(URL::asset('cleanui/vendors/bootstrap-show-password/bootstrap-show-password.min.js')); ?>"></script>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('cleanui/components/menu-top/common/menu-top.cleanui.css')); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('cleanui/components/menu-right/common/menu-right.cleanui.css')); ?>">
        ...
        <script src="<?php echo e(URL::asset('cleanui/components/menu-top/common/menu-top.cleanui.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('cleanui/components/menu-right/common/menu-right.cleanui.js')); ?>"></script>
...
$(document).ready(function () {
    ...
    <body class="cui-config-borderless cui-menu-colorful cui-theme-light cui-menu-left-shadow">
...
</html><?php /**PATH C:\xampp\htdocs\educationhero\resources\views/layouts/auth.blade.php ENDPATH**/ ?>