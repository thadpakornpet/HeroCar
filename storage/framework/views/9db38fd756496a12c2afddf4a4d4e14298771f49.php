                        ...
                        <div class="modal-body">
                            <div class="form-group">
                              <label>เลือกผู้รับ</label>
                                <select class="form-control select2" multiple="multiple" name="to[]" required style="font-family: 'Pridi', serif;" onchange="yesnoCheck(this);" required>
                                    ...
                                    <option value="<?php echo e($mailuser->email); ?>"><?php echo e($mailuser->name); ?> [<?php echo e($mailuser->email); ?>]</option>
                            ...
                            <div class="form-group" id="other" style="display: none;">
                                ...
                                <input type="text" style="font-family: 'Pridi', serif;" class="form-control" name="emails" placeholder="email">
                            </div>
                            <div class="form-group">
                              <label>ชื่อเรื่อง</label>
                                <input type="text" style="font-family: 'Pridi', serif;" class="form-control" placeholder="Subject" name="subject" required/>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" style="font-family: 'Pridi', serif;" class="form-control" name="email" placeholder="" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn width-200 btn-primary">
