...
<div class="cui-layout-content">
    <nav class="cui-breadcrumbs cui-breadcrumbs-bg">
        <span class="font-size-18 d-block">
            ...
            <strong><?php echo app('translator')->getFromJson('logs.d'); ?></strong>
        </span>
    </nav>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\educationhero\resources\views/home.blade.php ENDPATH**/ ?>