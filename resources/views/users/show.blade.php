                        ...
                        <dl class="row">
                                    ...
                                    <dd class="col-xl-3">
                                      @if(isset($user->getprofiles->address1))
                                        {{$user->getprofiles->address1}} {{$user->getprofiles->road1}} {{$user->getprofiles->subdistrict1}} {{$user->getprofiles->district1}} {{$user->getprofiles->province1}} {{$user->getprofiles->zipcode1}}
                                      @endif
                                    </dd>
                                    ...
                                    <dt class="col-xl-1"></dt>
                                    <dt class="col-xl-2">@lang('logs.address')#2</dt>
                                    <dd class="col-xl-3">
                        ...
                        <table class="table table-hover nowrap" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $mail->title }}</td>
                                    <td>{{ $mail->remark }}</td>
                                    <td>@if($mail->attachment)<a href="{{ url('/mails/getDownload/'.$mail->attachment) }}"><i class="icmn-attachment text-default"></i></a>@endif</td>
