                    ...
                    <div class="cui-login-block-inner">
                        <div class="cui-login-block-form">
                            <h4 class="text-uppercase">
                                <strong>@lang('logs.linkreset')</strong>
                            </h4>
                            <br />
                            <form id="form-validation" name="form-validation" method="POST" action="{{ route('password.request') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="token" value="{{ $token }}">
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 control-label">@lang('logs.email')</label>

                                    <input id="email" type="email" style="font-family: 'Pridi', serif;" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input id="password" type="password" style="font-family: 'Pridi', serif;" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input id="password-confirm" type="password" style="font-family: 'Pridi', serif;" class="form-control" name="password_confirmation" required autocomplete="new-password">
                                ...
                                <div class="form-actions right">
                                    <button type="submit" class="btn btn-primary mr-5">@lang('logs.linkresetb')</button>
                                </div>
                            </form>
                        </div>
                    </div>
