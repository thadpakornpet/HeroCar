                ...
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="form-group row">
                                                        ...
                                                        <label for="type_business" class="col-md-2 control-label">@lang('company.typecompany') :</label>
                        ...
                        <option value='13'{!! $company[0]->type_business == 13 ? 'selected' : '' !!}>@lang('company.publishing')</option>
                         ...
                         <option value='40'{!! $company[0]->type_business == 40 ? 'selected' : '' !!}>@lang('company.other')</option>
                                                        ...
                                                        <label for="vat" class="col-md-2 control-label">@lang('company.taxid') :</label>
                                                    ...
                                                    <div class="form-group row">
                                                    <label for="name_business_th"  class="col-md-2 control-label">@lang('company.nameth') :</label>

                                                    <div class="col-md-4">
                                                        <input id="name_business_th" value="{!! $company[0]->name_business_th !!}" type="text" class="form-control" name="name_business_th" required>
                                                    </div>

                                                    <label for="name_business_eng" class="col-md-2 control-label">@lang('company.nameen') :</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="address_company" class="col-md-2 control-label">@lang('company.address') :</label>
                                                    ...
                                                    <label for="size" class="col-md-2 control-label">@lang('company.office') :</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="phone_office" class="col-md-2 control-label">@lang('company.phone') :</label>

                                                    <div class="col-md-4">
                                                        <input id="phone_office" value="{!! $company[0]->phone_office !!}" type="text" class="form-control" name="phone_office" required>
                                                    </div>

                                                    <label for="phone" class="col-md-2 control-label">@lang('company.mobile') :</label>
                                        ...
                                        <div class="form-group row">
                                            <label for="website" class="col-md-2 control-label">@lang('company.website') :</label>
